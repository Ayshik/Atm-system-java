...
public class sign_up extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaproject/img_193664.png"))); // NOI18N
...
insertIntoDB();        // TODO add your handling code here:
 ...
 public void insertIntoDB()
	...
	{
		String query = "INSERT INTO users VALUES ('"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+jTextField3.getText()+"','"+jTextField4.getText()+"','"+jTextField5.getText()+"','"+jTextField6.getText()+"','"+jComboBox1.getSelectedItem().toString()+"','"+dateChooserCombo2.getText()+"','500','0','0')";
		
                System.out.println(query);
              
              String pin=new String(jTextField6.getText());
               String confirmpin=new String(jTextField7.getText());
