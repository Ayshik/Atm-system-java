 ...
 String getDate()
    ...
    public void updateInDB() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (accountNumber.equals(jLabel1.getText())) {
                    prevBalance = balance;
                    newBalance = prevBalance - Double.parseDouble(jTextField1.getText());
        ...
        try {
            ...
            query1 = "UPDATE users SET Withdrawn=" + jTextField1.getText() + " where Email='" + jLabel1.getText() + "'";
            query2 = "INSERT INTO transaction VALUES ('" + jLabel1.getText() + "','" + jTextField1.getText() + "','"+NowTime+"')";
